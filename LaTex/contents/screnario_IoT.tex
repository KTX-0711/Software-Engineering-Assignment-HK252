\subsubsection{Use-case U4.1: Cập nhật trạng thái vị trí đỗ}
\vspace{0.5cm}
\noindent
...
- \textbf{E2 (Dữ liệu không hợp lệ)}: Nếu hệ thống phát hiện gói tin sai cấu trúc, hệ thống sẽ từ chối lưu bản ghi và tự động ghi lại lỗi để Admin kiểm tra. \newline 
- \textbf{E3 (Thiết bị không có trong danh sách):} Nếu hệ thống phát hiện gói tin được gửi từ một thiết bị nằm trong danh sách thiết bị, hệ thống sẽ từ chối lưu bản ghi và tự động ghi lại lỗi để Admin kiểm tra. \\ \hline
\end{tabularx}
\newpage

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{pictures/seq_4.1.png}
    \caption{Sequence Diagram --- U4.1: Cập nhật trạng thái vị trí đỗ}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{pictures/act_4.1.png}
    \caption{Activity Diagram --- U4.1: Cập nhật trạng thái vị trí đỗ}
\end{figure}
\newpage
...
\subsubsection{Use-case U4.2: Hiển thị trạng thái bãi xe}
\vspace{0.5cm}
\noindent
\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}p{4cm}|X|}
\hline
...
3. Hệ thống hiển vị trí chính xác của những vị trí chỗ trống/đã có xe và xuất lên giao diện dưới dạng sơ đồ bãi đỗ chứa các thông tin như: và mũi tên hướng dẫn đến vị trí đỗ xe gần nhất, trạng thái vị trí đỗ có trống hay không, bãi giữ xe có đang đầy hay không. \\ \hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{pictures/seq_4.2.png}
    \caption{Sequence Diagram --- U4.2: Hiển thị trạng thái bãi xe}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{pictures/act_4.2.png}
    \caption{Activity Diagram --- U4.2: Hiển thị trạng thái bãi xe}
\end{figure}
\newpage
...
\subsubsection{Use-case U4.3: Thông báo cảm biến lỗi}
\vspace{0.5cm}
\noindent
\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}p{4cm}|X|}
\hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{pictures/seq_4.3.png}
    \caption{Sequence Diagram --- U4.3: Thông báo cảm biến lỗi}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\linewidth]{pictures/act_4.3.png}
    \caption{Activity Diagram --- U4.3: Thông báo cảm biến lỗi}
\end{figure}
\newpage
