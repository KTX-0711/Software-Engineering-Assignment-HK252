...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth} % Độ rộng chiếm 45% chiều rộng văn bản
        ...
        \caption{Giao diện thông báo khi có sự cố ở thiết bị IoT}
        \label{fig:statechart1}
    \end{subfigure}
    \hfill % Khoảng trống linh hoạt giữa hai hình
    % Hình 2 bên phải
    \begin{subfigure}[b]{0.45\textwidth} % Độ rộng chiếm 45% chiều rộng văn bản
        \centering
        \includegraphics[width=\linewidth]{pictures/notice2.png} % Điều chỉnh width một chút để cân đối hơn nếu cần
        \caption{Giao diện thông báo khi Admin bỏ quên việc xác nhận sự cố thiết bị IoT}
        \label{fig:statechart2}
    \end{subfigure}
    
    % Chú thích chung cho cả cụm hình (tùy chọn)
    \caption{Các giao diện thông báo tình trạng thiết bị IoT}
    \label{fig:both_statecharts}
\end{figure}
