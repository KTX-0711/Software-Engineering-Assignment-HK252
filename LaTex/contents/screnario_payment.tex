...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{pictures/seq_lichsugiaodich.png}
    \caption{Sequence diagram cho Use-case U3.1: Xem lịch sử giao dịch cá nhân}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{pictures/lichsugiaodich.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{pictures/seq_thanhtoanthucong.png}
    \caption{Sequence diagram cho Use-case U3.3: Thanh toán thủ công}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{pictures/thanhtoanthucong.png}
