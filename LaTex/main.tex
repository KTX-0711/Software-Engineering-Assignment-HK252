...
\begin{itemize}
    ...
    \item \textbf{Giai đoạn 4 - Xử lý hậu kỳ:} Dựa trên tổng thời gian của phiên đỗ xe và chính sách giá đã thiết lập, hệ thống tự động tính toán chi phí cho phiên này. Chi phí này được cộng dồn vào tài khoản ghi nợ của khách hàng. Vào cuối chu kỳ (vào cuối tháng), phiên gửi xe sẽ được chuyển sang trạng thái \textit{Chờ thanh toán}. Sau khi khách hàng hoàn tất nghĩa vụ tài chính, phiên sẽ chính thức khép lại với trạng thái \textit{Đã thanh toán}.
    \item \textbf{Giai đoạn ngoại lệ:} Trong quá trình hoạt động, nếu xảy ra sự cố (khách mất thẻ, xe lưu bãi quá thời gian quy định, lỗi cảm biến), phiên gửi xe sẽ bị treo ở trạng thái \textit{Ngoại lệ}. Lúc này, cần sự can thiệp thủ công của nhân viên vận hành để xác minh và đóng phiên hợp lệ.
\end{itemize}
...
\subsection{Screnario cho nhóm tiện ích bãi xe}
